...
const ku = {
  ...
  "Glucose test context": "Glucose test context",
  "Glucose context": "Glucose context",
  "Unknown / not sure": "Unknown / not sure",
  "Fasting": "Fasting",
  "Random": "Random / casual",
  "2-hour / after meal": "2-hour / after meal",
  "Model": "Model",
  "Clinical rules": "Clinical rules",
  "HbA1c is in a high range.": "HbA1c is in a high range.",
  "Blood glucose is elevated.": "Blood glucose is elevated.",
  "Blood glucose is elevated; interpretation depends on test context.": "Blood glucose is elevated; interpretation depends on test context.",
  "Fasting glucose is elevated.": "Fasting glucose is elevated.",
  "Fasting glucose is in a diabetes-range marker.": "Fasting glucose is in a diabetes-range marker.",
  "2-hour / after-meal glucose is elevated.": "2-hour / after-meal glucose is elevated.",
  "2-hour glucose is in a diabetes-range marker.": "2-hour glucose is in a diabetes-range marker.",
  "Random glucose is in a high range.": "Random / casual glucose is in a high range.",
  "BMI is in an obesity range.": "BMI is in an obesity range.",
  "Age increases diabetes risk in the model.": "Age increases diabetes risk in the model.",
  "Hypertension is present.": "Hypertension is present.",
  "Heart disease is present.": "Heart disease is present.",
  "No single high-risk input stands out; the result comes from the combined model features.": "No single high-risk input stands out; the result comes from the combined model features.",
...
Object.assign(ku, {
  ...
  "Glucose test context": "جۆری پشکنینی glucose",
  "Glucose context": "جۆری glucose",
  "Unknown / not sure": "نەزانراو / دڵنیا نیم",
  "Fasting": "بەڕۆژوو",
  "Random": "Random / هەڕەمەکی",
  "2-hour / after meal": "٢ کاتژمێر / دوای خواردن",
