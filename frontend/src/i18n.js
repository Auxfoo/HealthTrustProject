...
const ku = {
  ...
  "Doctor Audit Timeline": "مێژووی وردبینی پزیشک",
  "Institution Audit Timeline": "مێژووی وردبینی دامەزراوە",
  "Export PDF": "هەناردەکردنی PDF",
  "No history": "هیچ مێژوویەک نییە",
  "No History": "هیچ مێژوویەک نییە",
  "Security Model": "شێوازی پاراستن",
  "Client-side encryption": "ئینکریپشن لەلایەن کڵایەنتەوە",
  ...
  "Tamper-resistant audit trail": "شوێنەواری وردبینی دژەدەستکاری",
  "Grant, revoke, institution, and record events are written to Sepolia and shown as audit history.": "ڕووداوەکانی پێدان، وەرگرتنەوە، دامەزراوە و تۆمار لە Sepolia دەنووسرێن و وەک مێژووی وردبینی پیشان دەدرێن.",
  ...
  "ML is not diagnosis": "ML تەنها بۆ هەڵسەنگاندن بەکاردێت",
  ...
  "Diabetic Risk Indicated": "Diabetic Risk Indicated",
  "No Diabetic Risk Indicated": "No Diabetic Risk Indicated",
  "Main contributing values": "Main contributing values",
  ...
  "No Audit Events Yet": "ڕووداوی وردبینی نییە",
  "No audit events yet": "ڕووداوی وردبینی نییە",
  ...
  "Model": "Model",
  "Model input values": "Model input values",
  ...
  "Diabetes prediction results will appear here after you submit the form.": "Diabetes prediction results will appear here after you submit the form.",
...
const technicalEnglishKu = {
  ...
  "Doctor Audit Timeline": "Doctor Audit Timeline",
  "Institution Audit Timeline": "Institution Audit Timeline",
  "Security": "Security",
  ...
  "Record": "Record",
  "Record ID": "Record ID",
  "Accessible Records": "Accessible Records",
  "Shared records": "Shared records",
  "No Accessible Records": "No Accessible Records",
  "Upload Record": "Upload Record",
  "Record uploaded": "Record uploaded",
  "Record decrypted": "Record decrypted",
  "Access": "Access",
  ...
  "Waiting for MetaMask...": "Waiting for MetaMask...",
  "Confirm the transaction in MetaMask.": "Confirm the transaction in MetaMask.",
  "This is not a medical diagnosis.": "This is not a medical diagnosis.",
};

Object.assign(ku, technicalEnglishKu);
...
Object.assign(ku, {
  ...
  "Doctor and emergency access requests will appear here.": "داواکارییەکانی پزیشک و فریاکەوتن لێرە دەردەکەون.",
  Patients: "نەخۆشەکان",
  "Patient Workspace": "شوێنی کاری نەخۆش",
  "Care Documents": "بەڵگەنامەی چاودێری",
  "Care Docs": "بەڵگەنامەکانی چاودێری",
  "No Care Documents": "هیچ بەڵگەنامەی چاودێری نییە",
  "Documents sent by doctors will appear here.": "ئەو بەڵگەنامانەی پزیشکان دەنێرن لێرە دەردەکەون.",
  ...
  "Medium Risk": "مەترسی مامناوەند",
  "High Risk": "مەترسی بەرز",
  "Diabetic Risk Indicated": "مەترسی شەکرە دەستنیشان کرا",
  "No Diabetic Risk Indicated": "هیچ مەترسییەکی شەکرە دەستنیشان نەکرا",
  "Model input values": "بەهاکانی هاتووی مۆدێل",
  "This ML output is NOT a clinical diagnosis. A licensed clinician must review the patient context and confirm any care decision.": "ئەم دەرئەنجامی ML ـە دەستنیشانکردنی کلینیکی نییە. پزیشکێکی مۆڵەتپێدراو دەبێت بارودۆخی نەخۆش پێداچوونەوە بکات و هەر بڕیارێکی چاودێری پشتڕاست بکاتەوە.",
  "Diabetes prediction results will appear here after you submit the form.": "دەرئەنجامەکانی پێشبینی شەکرە دوای ناردنی فۆڕمەکە لێرە دەردەکەون.",
  "PDF auto-fill works only after opening a text-based PDF record; scanned image PDFs need manual entry.": "پڕکردنەوەی خۆکاری PDF تەنها دوای کردنەوەی تۆماری PDF ـی دەق کار دەکات؛ PDF ـە وێنە سکانکراوەکان پێویستیان بە داخڵکردنی دەستی هەیە.",
  "Unable to get diabetes prediction": "نەتوانرا پێشبینی شەکرە وەربگیرێت",
  "must be a valid number.": "دەبێت ژمارەیەکی دروست بێت.",
  "must be between": "دەبێت لەنێوان",
  and: "و",
  "Revoking access stops future authorized access and removes shared encrypted keys. It cannot remove copies that were already decrypted or downloaded.": "وەرگرتنەوەی دەستگەیشتن ڕێ لە دەستگەیشتنی ڕێپێدراوی داهاتوو دەگرێت و کلیلە نهێنیکراوە هاوبەشکراوەکان لادەبات. ناتوانێت ئەو کۆپییانە بسڕێتەوە کە پێشتر کرانەوە یان داگیران.",
  "When a new doctor joins an institution that already has record access, share keys again so that doctor receives a MetaMask-encrypted key envelope.": "کاتێک پزیشکێکی نوێ پەیوەست دەبێت بە دامەزراوەیەک کە پێشتر دەستگەیشتنی تۆماری هەیە، جارێکی تر کلیلەکان هاوبەش بکە بۆ ئەوەی ئەو پزیشکە پاکەتی کلیلێکی نهێنیکراوی MetaMask وەربگرێت.",
  "This institution has no doctors to receive the encrypted key.": "ئەم دامەزراوەیە هیچ پزیشکێکی نییە بۆ وەرگرتنی کلیلی نهێنیکراو.",
  "Submitting...": "دەنێردرێت...",
  Submit: "ناردن",
  Grant: "پێدان",
  Revoke: "وەرگرتنەوە",
  ...
  Lab: "تاقیگە",
  Diagnosis: "پشکنین",
  Imaging: "پشکنینی وێنەیی",
  "Patient wallet": "جزدانی نەخۆش",
  "Enter a valid doctor wallet address": "تکایە ناونیشانی جزدانی پزیشکی دروست بنووسە",
  Prescription: "ڕێنمایی دەرمان",
  "Security Model": "مۆدێلی پاراستن",
  "Audit Events": "ڕووداوەکانی وردبینی",
  "Audit Timeline": "مێژووی وردبینی",
  ...
  "No Notes": "هیچ تێبینییەک نییە",
  "No Documents": "هیچ بەڵگەنامەیەک نییە",
  "No Membership History": "هیچ مێژووی ئەندامێتی نییە",
  "No Emergency-Visible Records": "هیچ تۆمارێکی فریاکەوتن نییە",
  "Model input values": "نرخە داخڵکراوەکانی مۆدێل",
  "Blood glucose level": "ئاستی glucose لە خوێن",
  "Care document generated inside the HealthTrust patient vault.": "بەڵگەنامەی چاودێری لەناو قەفەزی نەخۆشی HealthTrust دروستکرا.",
  "Created": "دروستکراوە",
  "Doctor wallet": "جزدانی پزیشک",
  "Clinical Content": "ناوەڕۆکی کلینیکی",
  "Encrypted file is stored on IPFS.": "پەڕگەی نهێنیکراو لە IPFS پاشەکەوتکراوە.",
  "Storage Reference": "سەرچاوەی پاشەکەوت",
  "HealthTrust care document - prototype, not a clinical certification": "بەڵگەنامەی چاودێری HealthTrust - نموونەیە، پشتڕاستکردنەوەی کلینیکی نییە",
  "Patient Audit Report": "ڕاپۆرتی وردبینی نەخۆش",
  "Tamper-resistant access and workflow timeline exported from HealthTrust.": "هێڵی کاتی دەستگەیشتن و کارڕەوتی دژەدەستکاری لە HealthTrust هەناردەکرا.",
  "Generated": "دروستکراوە",
  "Events": "ڕووداوەکان",
  "Network": "تۆڕ",
  "Sepolia prototype": "نموونەی Sepolia",
  "Target": "ئامانج",
  "HealthTrust audit report - blockchain events plus application workflow events": "ڕاپۆرتی وردبینی HealthTrust - ڕووداوەکانی بلۆکچەین و کارڕەوتی ئەپلیکەیشن",
  "Institution Audit Report": "ڕاپۆرتی وردبینی دامەزراوە",
  "Membership, shared-record, and access activity exported from HealthTrust.": "چالاکی ئەندامێتی، تۆماری هاوبەشکراو و دەستگەیشتن لە HealthTrust هەناردەکرا.",
  "Admin wallet": "جزدانی بەڕێوەبەر",
  "Pending membership requests": "داواکارییەکانی ئەندامێتی چاوەڕوان",
  "Monthly encrypted key events": "ڕووداوەکانی کلیلی نهێنیکراوی مانگانە",
  "Shared record categories": "پۆلەکانی تۆماری هاوبەشکراو",
  "Security Note": "تێبینی پاراستن",
  "Encrypted files remain off-chain. The report summarizes permissions, key envelopes, membership actions, and blockchain events.": "پەڕگە نهێنیکراوەکان لە دەرەوەی زنجیرە دەمێننەوە. ئەم ڕاپۆرتە پوختەی مۆڵەتەکان، پاکەتەکانی کلیل، کردارەکانی ئەندامێتی و ڕووداوەکانی بلۆکچەینە.",
  "Revocation prevents future authorized access but cannot erase files that were already downloaded or decrypted.": "وەرگرتنەوە ڕێگری لە دەستگەیشتنی مۆڵەتدراوی داهاتوو دەکات، بەڵام ناتوانێت ئەو پەڕگانە بسڕێتەوە کە پێشتر داگیراون یان کراونەتەوە.",
  "HealthTrust institution audit report - Sepolia prototype": "ڕاپۆرتی وردبینی دامەزراوەی HealthTrust - نموونەی Sepolia",
});
...
function hasGarbledEncoding(value) {
  return /[ØÙÛÚ]/.test(String(value));
}
...
const kuPhraseRules = [
  ...
  [/\bfrom\b/g, "لە"],
  [/\blab\b/g, "تاقیگە"],
  [/\bprescription\b/g, "ڕێنمایی دەرمان"],
...
export function LanguageProvider({ children }) {
  ...
  const t = useCallback(
    (text) => {
      ...
      if (language === "ku" && hasGarbledEncoding(translated)) return text;
...
function translateValue(value, language) {
  ...
  if (translated) {
    if (language === "ku" && hasGarbledEncoding(translated)) return value;
  ...
  phraseRules.forEach(([pattern, replacement]) => {
    if (language === "ku" && typeof replacement === "string" && hasGarbledEncoding(replacement)) return;
    const replaced = nextValue.replace(pattern, replacement);
    if (language === "ku" && !hasGarbledEncoding(nextValue) && hasGarbledEncoding(replaced)) return;
